...
В строке с **username** указываем название для сессии с нашим аккаунтом.
...
2. Открываем файл и вставляем ссылки на чаты, после чего нажимаем **Enter** и продолжаем вставлять ссылки на чаты. Ограничений на количество чатов нет.
